...
namespace VismaUtvikler.Controllers
{
    public class CustomerTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerTypeName,Description")] CustomerType customerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerTypeName,Description")] CustomerType customerType)
        {
            if (ModelState.IsValid)
            {
